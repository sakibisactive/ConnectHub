...
import { setActiveModal, toggleSound } from '../../store/slices/uiSlice';
...
export const Sidebar = () => {
  ...
  return (
    <aside className="w-80 md:w-96 bg-slate-900 border-r border-slate-800 flex flex-col h-full select-none">
      ...
      <div className="p-4 border-b border-slate-800/80 bg-slate-900/60 backdrop-blur-md">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              onClick={() => dispatch(setActiveModal('adminDashboard'))}
            ...
            <button
              onClick={() => dispatch(setActiveModal('profileSettings'))}
              className="p-2 rounded-xl text-slate-400 hover:text-slate-200 hover:bg-slate-800 transition-all"
      ...
      <div className="px-4 py-2 border-b border-slate-800/60 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1">
          <button
            onClick={() => dispatch(setActiveModal('userSearch'))}
          ...
          <button
            onClick={() => dispatch(setActiveModal('groupModal'))}
